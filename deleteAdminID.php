    ...
    <div class="col-sm-10">
        <h3>Admin deletion</h3>
         ...
         <div class="doct">
             ...
             $sql = "delete from admin where national_id = '$nationalID'";

             if ($conn -> query($sql) == true){
                 print "<p>Admin details updated Successfully</p>";
                 print "<a href='searchAdminDeleteID.php' class='btn btn-outline-success'>Delete another Admin</a>";
             }
             else{
                 print "<p>Admin details not deleted</p>";
                 print "<a href='searchAdminDeleteID.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
