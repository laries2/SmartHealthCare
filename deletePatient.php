        ...
        <h3>Patient deletion</h3>
         ...
         <div class="doct">
             ...
             if ($conn -> query($sql) == true){
                 ...
                 print "<a href='searchPatientDelete.php' class='btn btn-outline-success'>Delete another Patient</a>";
             }
             else{
                 print "<p>Patient's details not deleted</p>";
                 print "<a href='searchPatientDelete.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
