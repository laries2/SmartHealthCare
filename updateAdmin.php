        ...
        <h3>Admin registration</h3>
         ...
         <div class="doct">
             ...
             if ($conn -> query($sql) == true){
                 ...
                 print "<a href='searchAdminUpdate.php' class='btn btn-outline-success'>Update another Admin</a>";
             }
             else{
                 print "<p>Admin details not updated</p>";
                 print "<a href='searchAdminUpdate.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
