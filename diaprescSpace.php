...
<div class="container">
    ...
    <div class="col-sm-10">
        <h3>Patients' Dignosis and Prescription Information</h3>
        <form action="diagnosisSave.php" method="post">
         <div class="doct">
             ...
             <input type="text" name="diagnosis" placeholder="Diagnosis"  class="form-control" readonly
                    value="<?php print $row['diagnosis'];?>"><br>
             <label for=""><b>Prescription:</b></label>
             <input type="text" name="drugs_administered" placeholder="Prescription"  class="form-control carousel-item-left" height="50px" readonly
                    value="<?php print $row['drugs_administered'];?>"><br>
