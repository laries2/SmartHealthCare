    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <h3>Patients report</h3>
                ...
                <div class="doct">
                    <form action="reportPatientsDisplayDate.php" method="post">
                        <label for=""><b>Date From</b></label>
                        <input type="datetime-local" name="jDateFrom" class="form-control" required>
                        <label for=""><b>Date To</b></label>
                        <input type="datetime-local" name="jDateTo" class="form-control" required>
                        <hr>
                        <div class="buttons">
