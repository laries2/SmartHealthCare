        ...
        <h3>Pharmacist Update</h3>
         ...
         <div class="doct">
             ...
             if ($conn -> query($sql) == true){
                 ...
                 print "<a href='searchPharmacistUpdateID.php' class='btn btn-outline-success'>Update another Pharmacist</a>";
             }
             else{
                 print "<p>Pharmacist details not updated</p>";
                 print "<a href='searchPharmacistUpdateID.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
