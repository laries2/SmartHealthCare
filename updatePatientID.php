    ...
    <div class="col-sm-10">
        <h3>Patient Update</h3>
         ...
         <div class="doct">
             ...
             $cID = mysqli_real_escape_string($conn,$_POST['c_national_id']);
             $cRelationship = mysqli_real_escape_string($conn,$_POST['c_relationship']);
             ...
             $sql = "update patients set surname = '$surname',last_name = '$lastName',first_name = '$firstName',age ='$age',email_address = '$email',telephone_number ='$tel',companion_name ='$cName',c_national_id ='$cID',c_relationship ='$cRelationship' where national_id = '$nationalID'";

             if ($conn -> query($sql) == true){
                 print "<p>Patients details updated Successfully</p>";
                 print "<a href='searchPatientUpdateID.php' class='btn btn-outline-success'>Update another Patient</a>";
             }
             else{
                 print "<p>Patients details not updated</p>";
                 print "<a href='searchPatientUpdateID.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
