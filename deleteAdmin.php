        ...
        <h3>Admin deletion</h3>
         ...
         <div class="doct">
             ...
             if ($conn -> query($sql) == true){
                 ...
                 print "<a href='searchAdminDelete.php' class='btn btn-outline-success'>Delete another Admin</a>";
             }
             else{
                 print "<p>Admin details not deleted</p>";
                 print "<a href='searchAdminDelete.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
