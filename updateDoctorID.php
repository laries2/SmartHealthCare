    ...
    <div class="col-sm-10">
        <h3>Doctor Update</h3>
         ...
         <div class="doct">
             ...
             $contact = mysqli_real_escape_string($conn,$_POST['telephone']);
             $salary = mysqli_real_escape_string($conn,$_POST['salary']);
             $specs = mysqli_real_escape_string($conn,$_POST['specialization']);


             // Using MySQL Insert to post the data to the database table courses
             $sql = "update doctors set surname = '$surname',last_name = '$lastName',first_name = '$firstName',email = '$email',telephone ='$contact',salary ='$salary',specialization ='$specs' where national_id = '$nationalID'";

             if ($conn -> query($sql) == true){
                 print "<p>Doctor details updated Successfully</p>";
                 print "<a href='searchDoctorUpdateID.php' class='btn btn-outline-success'>Update another Admin</a>";
             }
             else{
                 print "<p>Doctor details not updated</p>";
                 print "<a href='searchDoctorUpdateID.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
