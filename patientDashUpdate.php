    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <a href="searchPatientUpdateID.php"><div class="jo btn btn-success">National ID</div></a>
                </div>
                <div class="col-sm-3">
                    <a href="searchPatientUpdate.php"><div class="jo btn btn-success">Job ID</div></a>
                </div>
                <div class="col-sm-3">
