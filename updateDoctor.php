        ...
        <h3>Doctor Update</h3>
         ...
         <div class="doct">
             ...
             if ($conn -> query($sql) == true){
                 ...
                 print "<a href='searchDoctorUpdate.php' class='btn btn-outline-success'>Update another Doctor</a>";
             }
             else{
                 print "<p>Doctor details not updated</p>";
                 print "<a href='searchDoctorUpdate.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
