...
<div class="container">
    ...
    <div class="col-sm-10">
        ...
        $sql = "insert into nurses(surname,last_name,first_name,national_id,email_address,telephone_number,job_code, salary)
values ('$surname','$lastName','$firstName','$nationalID',' $email','$tel','$jobCode','$salary')";
        if ($conn -> query($sql) == true){
            print "<p>New Nurse Added Successfully</p>";
            print "<a href='nurses.php' class='btn btn-outline-success'>Add New Nurse</a>";
        }
        else{
            print "<p>Nurse not added</p>";
            print "<a href='nurses.php' class='btn btn-outline-danger'>Try Again</a>";
        }
        mysqli_close($conn);
        ?>
    </div>
