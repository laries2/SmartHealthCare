    ...
    <div class="col-sm-10">
        <h3>Patient deletion</h3>
         ...
         <div class="doct">
             ...
             $sql = "delete from patients where national_id = '$nationalID'";

             if ($conn -> query($sql) == true){
                 print "<p>Patient's details deleted Successfully</p>";
                 print "<a href='searchPatientDeleteID.php' class='btn btn-outline-success'>Delete another Patient</a>";
             }
             else{
                 print "<p>Patient's details not deleted</p>";
                 print "<a href='searchPatientDeleteID.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
