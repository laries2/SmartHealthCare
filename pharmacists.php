...
<div class="container">
    ...
    <div class="col-sm-10">
        <h3>Pharmacists registration</h3>
        <form action="newPharmacist.php" method="post">
         <div class="doct">
             ...
             <input type="text" name="job_code"  value="PHAR1230" required class="form-control" disabled>
