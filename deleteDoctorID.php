    ...
    <div class="col-sm-10">
        <h3>Doctor deletion</h3>
         ...
         <div class="doct">
             ...
             $sql = "delete from doctors where national_id = '$nationalID'";

             if ($conn -> query($sql) == true){
                 print "<p>Doctor details deleted Successfully</p>";
                 print "<a href='searchDoctorDeleteID.php' class='btn btn-outline-success'>Delete another Doctor</a>";
             }
             else{
                 print "<p>Doctor details not deleted</p>";
                 print "<a href='searchDoctorDeleteID.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
