    ...
    <div class="col-sm-10">
        ...
        <form action="newPatient.php" method="post">
         <div class="doct">
             ...
             <input type="text" name="age" placeholder="Enter Patient's Age" required class="form-control">
             ...
             <input type="tel" name="telephone_number" placeholder="Your Telephone number" required class="form-control">
             <label for="" ><b>Facility:</b></label>
             <input type="text" name="facility" value="Smart Health Care Facility" required class="form-control" readonly>
             <label for="" ><b>Accompanied by:</b></label>
             <input type="text" name="companion_name" placeholder="Name of Companion"  class="form-control">
             <input type="text" name="c_national_id" placeholder="Companion's ID"  class="form-control">
             <input type="text" name="c_relationship" placeholder="Relationship with patient"  class="form-control">
             <input type="text" name="contact_number" placeholder="Companion's Contact"  class="form-control">
