...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-2 col1">
            <div class="row">
                <div class="col-sm-4"><img src="files/images/dashboardMain.png" alt=""  width="50" height="80px"></div>
        ...
        <div class="col-sm-10">
            <h3>Pharmacist's Update</h3><br><br>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <a href="searchPharmacistUpdateID.php"><div class="jo btn btn-success">National ID</div></a>
                </div>
                <div class="col-sm-3">
                    <a href="searchPharmacistUpdate.php"><div class="jo btn btn-success">Job ID</div></a>
                </div>
                <div class="col-sm-3">
