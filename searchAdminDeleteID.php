...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <h3>Admin Search to delete</h3>

                <div class="doct">
                    <form action="displayAdminDeleteID.php" method="post">
                        <select name="national_id" id="" class="form-control" required>
                            <?php
                            $conn = mysqli_connect("localhost","root","","smart");
                            if (!$conn){
                                die("Database Connection Error : " . mysqli_connect_error());
                            }
                            $sql = "select national_id from admin";
