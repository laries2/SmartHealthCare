    ...
    <div class="col-sm-10">
        <h3>Admin registration</h3>
         ...
         <div class="doct">
             ...
             $sql = "update admin set surname = '$surname',last_name = '$lastName',first_name = '$firstName',email_address = '$email',contact_number ='$contact' where national_id = '$nationalID'";

             if ($conn -> query($sql) == true){
                 print "<p>Admin details updated Successfully</p>";
                 print "<a href='searchAdminUpdateID.php' class='btn btn-outline-success'>Update another Admin</a>";
             }
             else{
                 print "<p>Admin details not updated</p>";
                 print "<a href='searchAdminUpdateID.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
