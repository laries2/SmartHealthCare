        ...
        <h3>Pharmacists deletion</h3>
         ...
         <div class="doct">
             ...
             if ($conn -> query($sql) == true){
                 ...
                 print "<a href='searchPharmacistDeleteID.php' class='btn btn-outline-success'>Delete another Pharmacist</a>";
             }
             else{
                 print "<p>Pharmacists details not deleted</p>";
                 print "<a href='searchPharmacistDeleteID.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
