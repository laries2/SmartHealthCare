    ...
    <div class="col-sm-10">
        <h3>Nurse deletion</h3>
         ...
         <div class="doct">
             ...
             $sql = "delete from nurses where national_id = '$nationalID'";

             if ($conn -> query($sql) == true){
                 print "<p>Nurse details deleted Successfully</p>";
                 print "<a href='searchNurseDelete.php' class='btn btn-outline-success'>Delete another Nurse</a>";
             }
             else{
                 print "<p>Nurse details not deleted</p>";
                 print "<a href='searchNurseDelete.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
