    ...
    <div class="col-sm-10">
        <h3>Doctor Update</h3>
         ...
         <div class="doct">
             ...
             $sql = "update nurses set surname = '$surname',last_name = '$lastName',first_name = '$firstName',email_address = '$email',telephone_number ='$tel',salary ='$salary' where national_id = '$nationalID'";

             if ($conn -> query($sql) == true){
                 print "<p>Nurse details updated Successfully</p>";
                 print "<a href='searchNurseUpdateID.php' class='btn btn-outline-success'>Update another Nurse</a>";
             }
             else{
                 print "<p>Nurse details not updated</p>";
                 print "<a href='searchNurseUpdateID.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
