...
<div class="container">
    ...
    <div class="col-sm-10">
        <h3>Patient's prescription</h3><br><br><br>
        <h4>Input patients' id</h4>
        <form action="prescriptionSpace.php" method="post">
            ...
            <hr>
            <div class="buttons">
                <button type="submit" class="btn btn-primary">Proceed to prescription</button>
            </div>
        </form>
    </div>
</div>
