...
<head>
    ...
    <title>patient search delete</title>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <h3>Patient Search by National-ID</h3>

                <div class="doct">
                    <form action="displayPatientDeleteID.php" method="post">
                        <select name="searchDoctor" id="" class="form-control" required>
                            ...
                            $sql = "select national_id from patients";
