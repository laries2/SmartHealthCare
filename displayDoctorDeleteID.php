...
$sql = "select * from doctors where national_id = '$nationalID'";
...
<div class="container">
    ...
    <div class="col-sm-10">
        <h3>Doctor delete</h3>
        <form action="deleteDoctorID.php" method="post">
         <div class="doct">
             ...
             <input type="email" name="email" placeholder="Your Email address" required class="form-control" readonly
                    value="<?php print $row['email'];?>">
             <label for="" ><b>Telephone Number:</b></label>
             <input type="tel" name="telephone" placeholder="Your Telephone number" required class="form-control" readonly
                    value="<?php print $row['telephone'];?>">
             <label for=""><b>Salary:</b></label>
             <input type="text" name="salary" placeholder="Enter Salary" required class="form-control" readonly
                    value="<?php print $row['salary'];?>">

             <label for="" ><b>Speciality:</b></label>
             <input type="text" name="specialization" placeholder="Enter Salary" required class="form-control" readonly
                     value="<?php print $row['specialization'];?>">
