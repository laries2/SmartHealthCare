    ...
    <div class="col-sm-10">
        ...
        <form action="diagnosisSave.php" method="post">
         <div class="doct">
             ...
             <textarea type="text" name="drugs_administered" cols="70" rows="10" placeholder="Patients prescription"
                       value="<?php print $row['drugs_administered'];?>"></textarea>
