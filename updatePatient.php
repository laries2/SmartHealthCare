        ...
        <h3>Patient Update</h3>
         ...
         <div class="doct">
             ...
             if ($conn -> query($sql) == true){
                 ...
                 print "<a href='searchPatientUpdate.php' class='btn btn-outline-success'>Update another Patient</a>";
             }
             else{
                 print "<p>Patients details not updated</p>";
                 print "<a href='searchPatientUpdate.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
