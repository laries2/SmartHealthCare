...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-2 col1">
            ...
            <br><br><br><br>
            <div class="row">
                <a href="nurseDashboard.php">   <div class="col-sm-4"><img src="files/images/dashboardMain.png" alt="" width="210" height="100px"></div></a>
                <a href="nurseDashboard.php"><div class="col-sm-8"><b>Dashboard</b></div></a>
            </div>
            <br>
            <div class="row">
