        ...
        <h3>Doctor Update</h3>
         ...
         <div class="doct">
             ...
             if ($conn -> query($sql) == true){
                 ...
                 print "<a href='searchNurseUpdate.php' class='btn btn-outline-success'>Update another Nurse</a>";
             }
             else{
                 print "<p>Nurse details not updated</p>";
                 print "<a href='searchNurseUpdate.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
