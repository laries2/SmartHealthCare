...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <h3>Patients's Report</h3><br><br>


            <div class="row">

                <div class="col-sm-3">
                    <h4>Generate report Using:</h4>
                </div>
                <div class="col-sm-3">
                    <a href="patientsReportDate.php"><div class="jo btn btn-success">Dates</div></a>
                </div>
                <div class="col-sm-3">
                    <a href="patientsReport.php"><div class="jo btn btn-success">All patients</div></a>
                </div>
                <div class="col-sm-3">
