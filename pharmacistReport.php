...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <h3>Pharmacist report</h3>

                <div class="doct">
                    <form action="reportPharmacistDisplay.php" method="post">
                        <select name="job_code" id="" class="form-control" required>
                            <?php
                            $conn = mysqli_connect("localhost","root","","smart");
                            if (!$conn){
                                die("Database Connection Error : " . mysqli_connect_error());
                            }
                            $sql = "select job_code from pharmacists";
                            ...
                            if ($result -> num_rows > 0){
                                ...
                                while ($row = $result -> fetch_assoc()){
                                    ?>
                                    <option value="<?php echo $row['job_code'];?>"><?php echo $row['job_code'];?></option>
                                    <?php
                                }
                            }
                            mysqli_close($conn);
