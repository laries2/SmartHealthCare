        ...
        <h3>Doctor deletion</h3>
         ...
         <div class="doct">
             ...
             if ($conn -> query($sql) == true){
                 ...
                 print "<a href='searchDoctorDelete.php' class='btn btn-outline-success'>Delete another Doctor</a>";
             }
             else{
                 print "<p>Doctor details not deleted</p>";
                 print "<a href='searchDoctorDelete.php' class='btn btn-outline-danger'>Try Again</a>";
             }
             mysqli_close($conn);
             ?>
